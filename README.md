...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-rht6e9a.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-rht6e9a.containers.anotherwebservice.com/
...
```
git clone git@github.com:romandze/container-rht6e9a.git
cd container-rht6e9a
```
...
```
docker attach container-rht6e9a
```
